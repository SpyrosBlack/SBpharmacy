...
VALUES (23, 'Medicine 1');
INSERT INTO `pharmacydb`.`medicine` (`medicineprice`, `medicinename`)
VALUES (2, 'Medicine 2');
INSERT INTO `pharmacydb`.`medicine` (`medicineprice`, `medicinename`)
VALUES (56, 'Medicine 3');

-- populate pharmacy table
INSERT INTO `pharmacydb`.`pharmacy` (`pharmacyaddress`, `pharmacycity`, `pharmacyname`, `lat`, `lng`, `username`)
VALUES ('lala', 'lala', 'lala', 38.1725, 23.725, 'Spiros');
INSERT INTO `pharmacydb`.`pharmacy` (`pharmacyaddress`, `pharmacycity`, `pharmacyname`, `lat`, `lng`, `username`)
VALUES ('lala', 'lala', 'lala', 38.1725, 23.725, 'Kostas');

-- populate inventory table
INSERT INTO `pharmacydb`.`inventory` (`dateofcount`, `medicineid`, `pharmacyid`, `quantity`)
